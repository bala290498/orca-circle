    ...
    <section id="how-it-works" className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-white via-primary-50/30 to-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Timeline - Left side timeline, right side cards */}
          <div className="relative max-w-5xl mx-auto">
            {/* Vertical timeline line - on the left */}
            <div className="absolute left-6 top-0 bottom-0 w-0.5 md:w-1 bg-gradient-to-b from-primary-400 via-primary-500 to-secondary-500"></div>
              ...
              {steps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute left-0 z-10 flex-shrink-0 -ml-6">
                      ...
                      {/* Connecting line */}
                      {!isLast && (
                        <div className="absolute top-full left-1/2 -translate-x-1/2 w-0.5 h-5 bg-gradient-to-b from-primary-400 to-primary-500"></div>
                      )}
                    </div>
                    
                    {/* Right card - all cards on right side */}
                    <div className="w-full md:w-[calc(100%-3rem)] ml-12 md:ml-16 relative">
